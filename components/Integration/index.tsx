      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Seamless Integration with Leading Tools and Platforms.`,
              description: `Upliftio offers seamless integration with leading tools and platforms, ensuring that your data is always accessible and up-to-date. Manage your data remotely, from anywhere, at any time.`,
            }}
          />
